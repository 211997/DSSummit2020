...
# Function to compute fitness score for the sequence arrived
def fitness(individual):
    h_collisions = sum([individual.count(queen)-1 for queen in individual])/2
    d_collisions = 0
...
# Function to get the probability score 
def prob_score(individual, fitness):
...
def genetic_queen(population, fitness):
    ...
    new_population = []
    probabilities = [prob_score(n, fitness) for n in population]
